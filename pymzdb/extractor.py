...
def flatten(iterable):
    """
    Flatten iterable see url
    The following code runs faster than the previous one
...
if __name__ == "__main__":
    ...
    s = "D:\\Utilisateurs\\Marc\\Desktop\\developpement\\plantage fichiers\\test-dia\\OFMMA150403_114.raw.mzDB"
    mzdb_reader = MzDBReader(s)
    scan_id, mzs, ints = mzdb_reader.get_scan(22305)
    print len(ints)
